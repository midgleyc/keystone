...
The specific features of the editor that are enabled can be customised.
Try disabling certain features below.
It will update the code block below and the editor above.

<DocumentFeaturesFormAndCode />

### Inline Relationships

The document field can have inline relationships for things like mentions.
...
<summary>
  ...
  implemented as component blocks, see the implemention for Notice and Hero by expanding this.
</summary>
